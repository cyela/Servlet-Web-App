...
<form action="RegistrationServlet" method="post" onsubmit="return checkForm(this);">
    <input type="hidden" name="action" value=sign>
	    ...
	    <input type="text" id="Password" name="Password" placeholder="Password" onkeyup="CheckPasswordStrength(this.value)" required />
	    ...
	    <input type="Password" id="rePassword" name="rePassword" placeholder="Re-enter Password" required><br> 
