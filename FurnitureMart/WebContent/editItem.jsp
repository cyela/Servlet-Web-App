	...
	<fieldset>
		<div>
			<form action="ProductServlet" method="post">
				<input type="hidden" name="action" value=edit_item> <input
					type="text" name="productId" value='${editprod.getProductId()}'
					readonly> <input type="text" name="desc"
					value='${editprod.getDescription()}'> <input type="text"
					name="name" value='${editprod.getProductname()}'> <input
					type="text" name="price" value='${editprod.getProductprice()}'>
