...
<div class="topnav">
	...
	<a href="CartServlet?action=view_cart" style="float:right">View Cart</a>
</div>
...
<div class="leftcolumn">
	...
	<%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>
			<c:forEach var="item" items="${product}">
				  ...
				  <img class="thumbnail zoom" src="${pageContext.servletContext.contextPath }/ImageServlet?productId=<c:out value='${item.getProductId()}'/>" alt="" 
	                			style="align:left;width:200px; height:200px"/>
	                			
					<p align="centre">Product Name: ${item.getProductname()}</p>
					 <p align="centre">Price: ${item.getProductprice()}$ only</p>
...
<div class="rightcolumn">
	...
	<fieldset>
		...
		<div class="innerleftcolumn">
			...
			<%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>
				  <% if (usernn.getImage()!= null) { %>
				    <img src="${pageContext.servletContext.contextPath }/ImageServlet?email=${user.email}" alt="" style="width:75%" >
				    
				<% } else {%>
				   <img src="images/noimage.png" alt="" style="width:75%" >
				<% } %>
					<input type="button" id="myBtnpic" value="Edit Picture" style="width:75%" >
		...
		<div class="innerrightcolumn">
			  ...
			  <p>Address <input type="button" id="myBtn" value="Update"> </p>
			    <p>${address.address}</p>
			    <p>${address.city}</p>
			    <p>${address.state}</p>
			    <p>${address.zipcode}</p>
    ...
    <div class="modal-body">
      <div>
		...
		<form action="UserServlet" method="post">
		    ...
		    <input type="text" name="address" value="${address.address}" placeholder="Street, Apartment , unit, building" ><br>
		    <input type="text" name="city" value="${address.city}" placeholder="City" ><br>
		    <input type="text" name="state" value="${address.state}" placeholder="State"><br>
		    <input type="text" name="zipcode" value="${address.zipcode}" placeholder="zipcode"><br> 
    ...
    <div class="modal-body">
      <div>
		...
		<form action="UserServlet" method="post" enctype="multipart/form-data">
		  	 ...
		  	 <div>
		  	 	<p><input type="file" name="photo" size="50" id="uploadfile" value="Upload"/> <input type="submit"  value="Upload" ></p>
		  	 </div>
