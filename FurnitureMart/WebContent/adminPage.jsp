...
<body>
	<%
		...
		if (session.getAttribute("User") == null) {
			...
			ArrayList<Product> product = (ArrayList<Product>) request.getSession().getAttribute("product");
						...
						<div class="thumbnail">
							<div class="col-xs-12 col-md-6" style="align: center">
								...
								<div class="caption" style="align: right">
									...
									<div class="row">
										<div class="col-xs-12 col-md-6">
											<p class="lead">
												<c:out value='${item.getProductprice()}' />
												$
											</p>
										</div>
									</div>
							...
							<form action="ProductServlet" method="post">
								<input type="hidden" name="action" value="edit"> <input
									...
									type="submit" value="EDIT" style="width: 25%">
							</form>
							...
							<form action="ProductServlet" method="post">
								<input type="hidden" name="action" value="remove"> <input
									type="hidden" name="productId"
									value="<c:out value='${item.getProductId()}'/>"> <input
									type="submit" value="DELETE" style="width: 25%">
							</form>
						</div>
					</div>
				</div>
