		...
		<div class="column">
			<div class="card">
				<form action="HomeServlet" method="post">
					<input type="hidden" name="action" value="Login"> <label><b>User
							Name</label><br> <input type="text" id="uname" name="username"
						placeholder="enter user name.."><br> <label><b>Password</b>
					</label><br> <input type="Password" id="Password" name="Password"
						placeholder="enter Password" required><br> <input
						type="checkbox"
						onchange="document.getElementById('Password').type = this.checked ? 'text' : 'password'">
					Show password <input type="submit" value="Login">
					<p>
						Not a member yet? <a href="signup.jsp" title="Sign Up">Sign Up</a>
					</p>
				</form>
