					...
					<c:forEach var="item" items="${bufitems}">
					  <tr>			   
					    <td><form action="CartServlet" method="get">
							    ...
							    <p> <input type="submit" value="-" style=" width: 30px;background:red;height:30px; "><c:out value='${item.getProductName()}'/></p>
							  </form> </td>
					    <td><c:out value='${item.getPrice()*item.getQuantity()}'/>$</td>
					    <td> <form action="CartServlet" method="get">
					    			<input type="text"  name="quantity" value='${item.getQuantity()}' style="width:80px;" style="text-align:center;">
	...
	<div style="float: left; width: 600px;">
			...
			<tr>
				 ...
				 <form action="HomeServlet" method="get">
					 ...
					 <input type="submit" value="Continue shopping" style=" width: 180px; ">
				 </form>
			     ...
			     <form action="CartServlet" method="get">
			        <input type="hidden" name="action" value="place">
			     	<input type="submit" value="Place Order" style=" width: 150px; ">
			     </form>
